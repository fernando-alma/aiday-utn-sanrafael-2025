...
<body>
    ...
    <div class="container">
        <section id="project-detail" class="form-section">
            <span class="back-btn" style="cursor:pointer; display:flex; gap: 8px; align-items: center; margin-block: 8px; width: fit-content;" onclick="window.location.href='project-list'">
