   ...
   <section class="visual-banner">
        <div class="container">
            ...
            <div class="visual-banner-cta">
                <a href="project-list" class="hero-cta">
                    Ver Proyectos 
                </a>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="collaborators-grid">
                <div class="collaborator-card">
                    ...
                    <div class="collaborator-name">Juan Pérez</div>
                    <div class="collaborator-role">Organizador</div>
                </div>
                <div class="collaborator-card">
                    <div class="collaborator-avatar"></div>
                    <div class="collaborator-name">María López</div>
                    <div class="collaborator-role">Speaker IA</div>
                </div>
                <div class="collaborator-card">
                    <div class="collaborator-avatar"></div>
                    <div class="collaborator-name">Carlos G.</div>
                    <div class="collaborator-role">Mentor Tech</div>
                </div>
                <div class="collaborator-card">
                    <div class="collaborator-avatar"></div>
                    <div class="collaborator-name">Ana Rivas</div>
                    <div class="collaborator-role">Organizador</div>
                </div>
                <div class="collaborator-card">
                    <div class="collaborator-avatar"></div>
                    <div class="collaborator-name">David S.</div>
                    <div class="collaborator-role">Speaker Dev</div>
                </div>
                <div class="collaborator-card">
                    <div class="collaborator-avatar"></div>
                    <div class="collaborator-name">Laura M.</div>
                    <div class="collaborator-role">Sponsor</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-ready">
        <div class="container">
            ...
            <a href="register" class="cta-ready-button">
                ¡Registrarme ahora!
            </a>
        </div>
    </section>
